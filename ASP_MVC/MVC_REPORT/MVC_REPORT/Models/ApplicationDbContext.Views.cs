...
[assembly: DbMappingViewCacheTypeAttribute(
    typeof(MVC_REPORT.Models.ApplicationDbContext),
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySetsb49f34e6c04e86a9cadee4b01b4d20b290d97daab85c077ea90fad3e6e8c86f1))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySetsb49f34e6c04e86a9cadee4b01b4d20b290d97daab85c077ea90fad3e6e8c86f1 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "b49f34e6c04e86a9cadee4b01b4d20b290d97daab85c077ea90fad3e6e8c86f1"; }
        }
    ...
    SELECT VALUE -- Constructing Roles
        [MVC_REPORT.Models.IdentityRole](T1.IdentityRole_Id, T1.IdentityRole_Name)
    FROM (
        SELECT 
            T.Id AS IdentityRole_Id, 
            T.Name AS IdentityRole_Name, 
    ...
    SELECT VALUE -- Constructing IdentityUserRoles
        [MVC_REPORT.Models.IdentityUserRole](T1.IdentityUserRole_UserId, T1.IdentityUserRole_RoleId)
    FROM (
        SELECT 
            T.UserId AS IdentityUserRole_UserId, 
            T.RoleId AS IdentityUserRole_RoleId, 
    ...
    SELECT VALUE -- Constructing Users
        [MVC_REPORT.Models.ApplicationUser](T1.ApplicationUser_Id, T1.ApplicationUser_Email, T1.ApplicationUser_EmailConfirmed, T1.ApplicationUser_PasswordHash, T1.ApplicationUser_SecurityStamp, T1.ApplicationUser_PhoneNumber, T1.ApplicationUser_PhoneNumberConfirmed, T1.ApplicationUser_TwoFactorEnabled, T1.ApplicationUser_LockoutEndDateUtc, T1.ApplicationUser_LockoutEnabled, T1.ApplicationUser_AccessFailedCount, T1.ApplicationUser_UserName)
    FROM (
        SELECT 
            T.Id AS ApplicationUser_Id, 
            T.Email AS ApplicationUser_Email, 
    ...
    SELECT VALUE -- Constructing IdentityUserClaims
        [MVC_REPORT.Models.IdentityUserClaim](T1.IdentityUserClaim_Id, T1.IdentityUserClaim_UserId, T1.IdentityUserClaim_ClaimType, T1.IdentityUserClaim_ClaimValue)
    FROM (
        SELECT 
            T.Id AS IdentityUserClaim_Id, 
            T.UserId AS IdentityUserClaim_UserId, 
    ...
    SELECT VALUE -- Constructing IdentityUserLogins
        [MVC_REPORT.Models.IdentityUserLogin](T1.IdentityUserLogin_LoginProvider, T1.IdentityUserLogin_ProviderKey, T1.IdentityUserLogin_UserId)
    FROM (
        SELECT 
            T.LoginProvider AS IdentityUserLogin_LoginProvider, 
            T.ProviderKey AS IdentityUserLogin_ProviderKey, 
