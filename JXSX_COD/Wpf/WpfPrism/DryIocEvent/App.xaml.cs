...
using DryIocEvent.ViewModels;
using System.Configuration;
using System.Data;
using System.Windows;

namespace DryIocEvent
{
    /// <summary>
    ...
    public partial class App : PrismApplication
    {
        ...
        {
            //注册弹窗（用户控件实现）
            containerRegistry.RegisterDialog<TCWin>();
            //注册弹窗窗口，用于替换用户控件弹窗，无此注册则使用用户控件实现
            containerRegistry.RegisterDialogWindow<TCwindow>();
        }
