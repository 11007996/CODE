...
namespace PMS
{
    public static class sqlhelpdb
    {
        ...
        /// 默认MES系统连接字符
        /// </summary>
        public static string connectionString = ConfigurationManager.ConnectionStrings["sqltesecon"].ConnectionString;

        /// <summary>
        /// 根据厂区自动获取连接字符
        /// </summary>
        /// <param name="Factory">厂区</param>
        public static void SetDbConnectionString(string Factory)
        {
            if (!string.IsNullOrEmpty(Factory))
            {
                string conStr = Factory.Trim().ToUpper() + "_DbConnectionString";
        ...
        public static int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlConnection cn = new SqlConnection(connectionString))
            {
                ...
                int i = ExecuteNonQuery(cn, commandType, commandText, commandParameters);
        ...
        /// <param name="connectstr">数据库链接字符串</param>
        /// <returns>返回影响的行数 int型</returns>
        public static int ExecuteNonQuery(string commandText, string connectstr)
        {
            return ExecuteNonQuery(connectstr, CommandType.Text, commandText);
        }
        ...
        public static int ExecuteNonQuery(string commandText, string connectstr, params SqlParameter[] commandParameters)
        {
            return ExecuteNonQuery(connectstr, CommandType.Text, commandText, commandParameters);
        }
        ...
        /// </summary>
        /// <remarks>
        /// 实例:DataSet ds = ExecuteDataset(connString, CommandType.StoredProcedure, "GetOrders");
        /// </remarks>
        ...
        /// <returns>DataSet</returns>
        public static DataSet ExecuteDataset(string commandText, string connectstr)
        {
            return ExecuteDataset(connectstr, CommandType.Text, commandText);
        }
        #endregion

        #region 公用方法

        #region 判断一条记录是否存在  + Exists(string strSql, string connectstr)
        public static bool Exists(string strSql, string connectstr)
        {
            object obj = GetSingle(strSql, connectstr);
            int cmdresult;
        ...
        #region 执行一条计算查询结果语句，返回查询结果（object） +GetSingle(string SQLString, string connectstr)
        /// <summary>
        /// 执行一条计算查询结果语句，返回查询结果（object）。
        /// </summary>
        /// <param name="SQLString">计算查询结果语句</param>
        /// <returns>查询结果（object）</returns>
        public static object GetSingle(string SQLString, string connectstr)
        {
        ...
        /// </summary>
        /// <remarks>
        /// 实例: DataSet ds = ExecuteDataset(connString, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">数据库连接字符串</param>
        /// <param name="commandType">CommandType（存储过程，文本，等等）</param>
        ...
        /// <returns></returns>
        public static DataSet ExecuteDataset(string spName, string connectstr, SqlParameter[] commandParameters)
        {
            return ExecuteDataset(connectstr, CommandType.StoredProcedure, spName, commandParameters);
        }
        #endregion
        ...
        public static object ExecuteScalar(string commandText, string connectstr)
        {
            return ExecuteScalar(connectstr, CommandType.Text, commandText);
        }
