...
{
    /// <summary>
    /// 一个软件基础类，提供常用的一些静态方法 -&gt; A software-based class that provides some common static methods
    /// </summary>
    public class SoftBasic
    {
        ...
        /// <summary>
        /// 设置或获取系统框架的版本号 -&gt; Set or get the version number of the system framework
        /// </summary>
        ...
        /// <summary>
        /// 一个通用的数组新增个数方法，会自动判断越界情况，越界的情况下，会自动的截断或是填充 -&gt; A common array of new methods, will
        /// automatically determine the cross-border situation, in the case of cross-border, will be
        /// automatically truncated or filled
        /// </summary>
        ...
        public static void AddArrayData<T>(ref T[] array, T[] data, int max)
        {
            ...
            if (array.Length == max)
            {
                for (int n = 0; n < array.Length - data.Length; n++)
                {
                    array[n] = array[n + 1];
                }
                for (int m = 0; m < data.Length; m++)
                {
                    array[array.Length - data.Length + m] = data[m];
                }
            }
        ...
        /// <summary>
        /// 将一个数组进行扩充到指定长度，或是缩短到指定长度 -&gt; Extend an array to a specified length, or shorten to a
        /// specified length or fill
        /// </summary>
        ...
        /// <summary>
        /// 获取一个枚举类型的所有枚举值，可直接应用于组合框数据 -&gt; Gets all the enumeration values of an enumeration type
        /// that can be applied directly to the combo box data
        /// </summary>
        ...
        /// <summary>
        /// 显示一个完整的错误信息，和额外的字符串描述信息 -&gt; Displays a complete error message, and additional string
        ...
        /// <summary>
        /// 获取一个异常的完整错误信息，和额外的字符串描述信息 -&gt; Gets the complete error message for an exception, and
        /// additional string description information
        /// </summary>
        ...
        /// <summary>
        /// 将16进制的字符串转化成Byte数据，将检测每2个字符转化，也就是说，中间可以是任意字符 -&gt; Converts a 16-character string into
        /// byte data, which will detect every 2 characters converted, that is, the middle can be
        /// any character
        /// </summary>
        ...
        /// <summary>
        /// 将byte数组按照双字节进行反转，如果为单数的情况，则自动补齐 -&gt; Reverses the byte array by double byte, or if the
        /// singular is the case, automatically
        /// </summary>
        ...
        /// <summary>
        /// 将原始的byte数组转换成ascii格式的byte数组 -&gt; Converts the original byte array to an ASCII-formatted
        /// byte array
        /// </summary>
        ...
        /// <summary>
        /// 将ascii格式的byte数组转换成原始的byte数组 -&gt; Converts an ASCII-formatted byte array to the original
        /// byte array
        /// </summary>
        /// <param name="inBytes">等待转换的byte数组</param>
        /// <returns>转换后的数组</returns>
        ...
        /// <summary>
        /// 从Byte数组中提取位数组，length代表位数 -&gt; Extracts a bit array from a byte array, length represents
        ...
        /// <summary>
        /// 拼接2个字节数组成一个数组 -&gt; Splicing 2 bytes to to an array
        /// </summary>
        ...
        /// <summary>
        /// 将一个byte数组的前面指定位数移除，返回新的一个数组 -&gt; Removes the preceding specified number of bits in a
        /// byte array, returning a new array
        /// </summary>
        ...
        /// <summary>
        /// 将一个byte数组的后面指定位数移除，返回新的一个数组 -&gt; Removes the specified number of digits after a byte
        ...
        /// <summary>
        /// 将一个byte数组的前后移除指定位数，返回新的一个数组 -&gt; Removes a byte array before and after the specified
        /// number of bits, returning a new array
        /// </summary>
        /// <param name="value">字节数组</param>
        ...
        /// <summary>
        /// 使用序列化反序列化深度克隆一个对象，该对象需要支持序列化特性 -&gt; Cloning an object with serialization
        /// deserialization depth that requires support for serialization attributes
        /// </summary>
        /// <param name="oringinal">源对象，支持序列化</param>
        /// <returns>新的一个实例化的对象</returns>
        /// <exception cref="T:System.NullReferenceException"></exception>
        /// <exception cref="T:System.NonSerializedAttribute"></exception>
        /// <remarks><note type="warning"><paramref name="oringinal"/> 参数必须实现序列化的特性 </note></remarks>
        /// <example>
        ...
        /// <summary>
        /// 获取一串唯一的随机字符串，长度为20，由Guid码和4位数的随机数组成，保证字符串的唯一性 -&gt; Gets a string of unique random
        /// strings with a length of 20, consisting of a GUID code and a 4-digit random number to
        /// guarantee the uniqueness of the string
        /// </summary>
