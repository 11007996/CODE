...
namespace Listen
{
    public partial class FrmSerialDebug
    {
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            ...
            BaseInfo.PortName = cmbCom.Text;
            BaseInfo.BaudRate = baudRate;
            BaseInfo.DataBits = dataBits;
            BaseInfo.StopBits = (StopBits)cmbStopBits.SelectedItem;
            BaseInfo.Parity = (Parity)cmbParity.SelectedItem;
            try
            {
        ...
        {
            cmbCom.Text = BaseInfo.PortName;
            tbBaudRate.Text = BaseInfo.BaudRate.ToString();
