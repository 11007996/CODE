...
namespace Asset.Util
{
    ...
    public class JwtHelp
    {
        ...
        /// <returns></returns>
        public static UserInfoDO GetJwtDecode(string token)
        {
            IJsonSerializer serializer = new JsonNetSerializer();
            ...
            var tokenInfo = decoder.DecodeToObject<UserInfoDO>(token, secret, verify: true);//token为之前生成的字符串
            return tokenInfo;
        }
    }
}