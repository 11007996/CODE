...
function renderComponentRoot(instance) {
  const { type: Component2, vnode, proxy, withProxy, props, propsOptions: [propsOptions], slots, attrs, emit: emit2, render: render3, renderCache, data, setupState, ctx, uid: uid2, appContext: { app: { config: { globalProperties: { pruneComponentPropsCache: pruneComponentPropsCache2 } } } }, inheritAttrs } = instance;
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      result = render3.call(proxyToUse, proxyToUse, renderCache, props, setupState, data, ctx);
    } else {
      fallthroughAttrs(inheritAttrs, props, propsOptions, Component2.props ? attrs : getFunctionalFallthrough(attrs));
      const render4 = Component2;
      result = render4.length > 1 ? render4(props, { attrs, slots, emit: emit2 }) : render4(
        props,
        null
...
function setupRenderEffect(instance) {
  ...
  const componentUpdateFn = () => {
    if (!instance.isMounted) {
      ...
      const { next: next2, bu, u } = instance;
      {
