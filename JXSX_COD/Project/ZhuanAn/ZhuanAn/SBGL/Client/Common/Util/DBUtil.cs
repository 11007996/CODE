...
namespace Common.Util
{
    public class DBUtil
    {
        ...
        public static string GetDeConnectionStr(string str)
        {
            ...
            {
                LogHelper.Error(typeof(DBUtil), null, ex);
                return "";
            }
        }
        ...
        public static bool ConnnectTest()
        {
            ...
            {
                ConnectionStr += ";Connect Timeout=5;";   //增加超时时间，缩短默认连接时间
            }
        ...
        {
            //网络检查
            string r = NetWorkHelper.PingIP(DBUtil.GetServerIP());
            if (!string.IsNullOrWhiteSpace(r))
            {
                return "无法Ping通服务器IP:" + DBUtil.GetServerIP() + ",状态:" + r;
            }
            //数据库连接检查
            if (!DBUtil.ConnnectTest())
            {
                return "数据库连接异常";
            }
        ...
        public static DataTable GetDataTable(string strSQL)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.Error(typeof(DBUtil), "sql操行错误", ex);
                throw ex;
            }
            finally
            {
