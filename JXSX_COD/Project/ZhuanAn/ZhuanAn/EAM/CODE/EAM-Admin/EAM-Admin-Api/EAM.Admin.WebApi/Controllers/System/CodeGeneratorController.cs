using EAM.CodeGenerator;
using EAM.CodeGenerator.Model;
using EAM.CodeGenerator.Service;
using EAM.Model;
...
namespace EAM.Admin.WebApi.Controllers
{
    ...
    public class CodeGeneratorController : BaseController
    {
        ...
        public IActionResult EditSave([FromBody] GenTableDto genTableDto)
        {
            ...
            DbResult<bool> r = GenTableService.UseTran(() =>
            {
        ...
        public IActionResult CodeGenerate([FromBody] GenerateDto dto)
        {
            ...
            //生成压缩包
            string zipReturnFileName = $"EAM-Admin.NET-{dto.GenTable.TableName}-{DateTime.Now:MMddHHmmss}.zip";
