...
namespace Infrastructure.Extensions
{
    ...
    public static partial class HttpContextExtension
    {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public static string GetFactoryId(this HttpContext context)
        {
            var factory = context.User.FindFirstValue("FactoryId");
            return !string.IsNullOrEmpty(factory) ? factory : "0";
        }
        ...
        public static ClientInfo GetClientInfo(this HttpContext context)
        {
            ...
            if (string.IsNullOrEmpty(str))//程序接口直接调用
                return null;
