...
using EAM.Applet.Api.Extensions;
using EAM.ServiceCore.Signalr;
using EAM.ServiceCore.SqlSugar;
using Infrastructure.Cache;
using Infrastructure.Converter;
using Infrastructure.WebExtensions;
...
app.MapControllers();
// 对于所有其他请求，返回index.html - 让前端路由接管
app.MapFallbackToFile("h5/{*path:nonfile}", "h5/index.html");
app.Run();