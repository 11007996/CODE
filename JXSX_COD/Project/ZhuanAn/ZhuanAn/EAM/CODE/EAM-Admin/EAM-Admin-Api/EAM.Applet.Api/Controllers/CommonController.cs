...
namespace EAM.Applet.Api.Controllers
{
    ...
    public class CommonController : BaseController
    {
        ...
        public IActionResult SendMsg(string msg, string toUser = "")
        {
            ...
            WxUserService.SendTextMsg("2781462", msg);
            return SUCCESS(msg);
        }
        ...
        public async Task<IActionResult> UploadFile([FromForm] UploadDto uploadDto, StoreType storeType = StoreType.LOCAL)
        {
            ...
            switch (storeType)
            {
                ...
                case StoreType.ALIYUN:
                    ...
                    file = new(formFile.FileName, uploadDto.FileName, fileExt, fileSize, uploadDto.FileDir, HttpContext.GetName())
                    {
        ...
        public IActionResult DownloadFile(string path, long fileId = 0)
        {
            ...
            if (fileId > 0)
            {
                ...
                throw new CustomException("未传递有效文件ID");
