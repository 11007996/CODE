...
namespace EAM.ServiceCore.Services
{
    public interface ISysUserRoleService : IBaseService<SysUserRole>
    {
        ...
        /// <param name="roleUserQueryDto"></param>
        /// <returns></returns>
        public PagedInfo<SysUser> GetExcludedFactoryUsersByRoleId(RoleUserQueryDto roleUserQueryDto);
        ...
        /// <returns></returns>
        int AddFactoryRoleUser(FactoryRoleUserOpeateDto model);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        int DelFactoryRoleUser(FactoryRoleUserOpeateDto model);
        ...
        /// <returns></returns>
        (string, object, object) ImportFactoryRoleUser(int roleId, string factory, List<EmpSimpleDto> list);
    }
}