...
namespace Infrastructure.Model
{
    ...
    public class OptionsSetting
    {
        ...
        public WxMessageConfig WxMessageConfig { get; set; }
        public OALoginConfig OALoginConfig { get; set; }
        public RSASecurityConfig RSASecurityConfig { get; set; }
    }
    ...
    public class Upload
    {
        ...
        public string[] AllowedExt { get; set; } = new string[0];
    }
