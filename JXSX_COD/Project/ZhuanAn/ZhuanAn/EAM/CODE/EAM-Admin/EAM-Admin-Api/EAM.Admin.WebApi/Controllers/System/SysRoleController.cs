...
namespace EAM.Admin.WebApi.Controllers.System
{
    ...
    public class SysRoleController : BaseController
    {
        ...
        [HttpGet("list")]
        public IActionResult List([FromQuery] SysRoleQueryDto parm)
        {
            var list = sysRoleService.SelectRoleList(parm);
        ...
        [ActionPermissionFilter(Permission = "system:role:list")]
        [HttpGet("dict")]
        public IActionResult DictRole([FromQuery] SysRoleQueryDto parm)
        {
            var list = sysRoleService.DictRole(parm);
