...
namespace Infrastructure.Controllers
{
    ...
    {
        protected static readonly string TIME_FORMAT_FULL = "yyyy-MM-dd HH:mm:ss";
        ...
        /// <param name="fileName"></param>
        /// <returns></returns>
        protected (string, string) ExportExcelMini(DataTable list, string sheetName, string fileName)
        {
            IWebHostEnvironment webHostEnvironment = (IWebHostEnvironment)App.ServiceProvider.GetService(typeof(IWebHostEnvironment));
            string sFileName = $"{fileName}{DateTime.Now:MM-dd-HHmmss}.xlsx";
            string fullPath = Path.Combine(webHostEnvironment.WebRootPath, "export", sFileName);
