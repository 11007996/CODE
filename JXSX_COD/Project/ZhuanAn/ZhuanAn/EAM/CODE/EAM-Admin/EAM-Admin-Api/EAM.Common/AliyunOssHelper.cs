...
namespace EAM.Common
{
    public class AliyunOssHelper
    {
        ...
        private static readonly string endpoint = AppSettings.GetConfig("ALIYUN_OSS:REGIONID");
        private static readonly string bucketName1 = AppSettings.GetConfig("ALIYUN_OSS:bucketName");
