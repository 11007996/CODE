...
namespace EAM.Admin.WebApi.Extensions
{
    public static class SwaggerExtension
    {
        ...
        public static void AddSwaggerConfig(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "EAM-Admin.NET Api",
                    Version = "v1",
                    Description = "系统管理",
                    //  Contact = new OpenApiContact { Name = "EAM-Admin doc", Url = new Uri("https://www.izhaorui.cn/doc") }
                });
                ...
                try
                {
                    ...
                    c.IncludeXmlComments(Path.Combine(baseDir, "EAM.Model.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "EAM.ServiceCore.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "EAM.Service.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "EAM.Admin.WebApi.xml"), true);
