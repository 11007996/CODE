...
using EAM.ServiceCore.Monitor.IMonitorService;
...
namespace EAM.ServiceCore.Signalr
{
    ...
    public class MessageHub : Hub
    {
        ...
        public static readonly List<OnlineUsers> users = new();
        ...
        public async Task SendMessage(long toUserId, string message)
        {
            ...
            else
            {
                await Clients.Clients(sendToUser)
                       .SendAsync(HubsConstant.ReceiveChat, messageDto);
            }
        ...
        public override Task OnConnectedAsync()
        {
            ...
            Clients.Clients(connIds.Select(f => f.ConnnectionId)).SendAsync(HubsConstant.OnlineInfo, userInfo);
            ...
            if (user != null)
            {
                ...
                if (userInfo != null)
                {
                    ...
                    UserOnlineLogService.AddUserOnlineLog(new Model.UserOnlineLog()
                    {
                        ...
                        UserIP = user.UserIP,
                        TodayOnlineTime = Math.Ceiling(userInfo.TodayOnlineTime),
