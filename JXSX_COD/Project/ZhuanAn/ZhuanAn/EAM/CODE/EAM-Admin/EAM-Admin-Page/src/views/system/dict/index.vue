  ...
  <div class="app-container">
    ...
    <el-table :data="typeList" v-loading="loading" border @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" width="170">
        <template #default="scope">
          <el-button text icon="edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:dict:edit']">
            {{ $t('btn.edit') }}
          </el-button>
          <el-button text icon="delete" @click="handleDelete(scope.row)" v-hasPermi="['system:dict:remove']">
            {{ $t('btn.delete') }}
          </el-button>
        </template>
      </el-table-column>
