<template>
  <div class="app-container">
    ...
    <vxe-table
      ...
      <vxe-column :title="$t('btn.operate')" align="center" width="180">
        <template #default="scope">
          <el-button-group>
            <el-button text icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:menu:edit']"></el-button>
            <el-button text icon="Plus" @click="handleAdd(scope.row)" v-hasPermi="['system:menu:add']"></el-button>
            <el-button text icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:menu:remove']"></el-button>
          </el-button-group>
        </template>
      </vxe-column>
    </vxe-table>
