  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('btn.operate')" align="center" width="140">
        <template #default="scope">
          <el-button v-hasPermi="['system:lang:edit']" text icon="edit" title="编辑" @click="handleUpdate(scope.row)"></el-button>
          <el-button v-hasPermi="['system:lang:delete']" text icon="delete" title="删除" @click="handleDelete(scope.row)"></el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-table
      ...
      <el-table-column :label="$t('btn.operate')" align="center" width="140">
        <template #default="scope">
          <el-button v-hasPermi="['system:lang:edit']" text icon="edit" title="编辑" @click="handleUpdateP(scope.row)">
            {{ $t('btn.edit') }}
          </el-button>
