<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="plus" @click="handleGetUserTable" v-hasPermi="['system:rolefactory:user:add']">
          {{ $t('btn.add') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-dropdown trigger="click" v-hasPermi="['system:rolefactory:user:import']">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item command="upload">
                <importData
                  templateUrl="system/RoleFactory/importTemplate"
                  :importUrl="'/system/RoleFactory/importData/' + role_id"
      ...
      <el-col :span="1.5">
        <el-button type="danger" plain icon="circle-close" @click="cancelAuthUserAll" v-hasPermi="['system:rolefactory:user:del']">
      ...
      <el-table-column label="操作" width="120" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['system:rolefactory:user:del']">
...
<script setup name="rolefactoryusers">
import importData from '@/components/ImportData'
import { getRole } from '@/api/system/role'
import { getRoleFactoryUsers, getExcludeFactoryUsers } from '@/api/system/userRoles'
import { listRoleFactory, addRoleFactoryUsers, delRoleFactoryUsers } from '@/api/system/roleFactory'
...
function getRoleUser() {
  loading.value = true
  getRoleFactoryUsers(roleUserQueryParams).then((response) => {
...
function handleClose() {
  const obj = { path: '/system/roleFactory' }
...
function handleGetUserTable() {
  ...
  getExcludeFactoryUsers(userQueryParams).then((response) => {
