<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系统内置" width="90" align="center" prop="configType">
      ...
      <el-table-column label="操作" width="160" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button text icon="edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:config:edit']">
            {{ $t('btn.edit') }}
          </el-button>
          <el-button text icon="delete" @click="handleDelete(scope.row)" v-hasPermi="['system:config:remove']">
            {{ $t('btn.delete') }}
          </el-button>
        </template>
      </el-table-column>
