  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" width="180">
        <template #default="scope">
          <el-button text icon="edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:post:edit']">
            {{ $t('btn.edit') }}
          </el-button>
          <el-button text icon="delete" @click="handleDelete(scope.row)" v-hasPermi="['system:post:remove']">
            {{ $t('btn.delete') }}
          </el-button>
        </template>
      </el-table-column>
