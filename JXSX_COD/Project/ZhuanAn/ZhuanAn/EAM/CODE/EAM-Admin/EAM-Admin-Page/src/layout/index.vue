  ...
  <el-container :class="classObj" class="app-layout" :style="{ '--current-color': theme }">
    ...
    <el-container class="main-container flex-center" :class="{ hasTagsView: needTagsView, sidebarHide: sidebar.hide }">
      <el-header :class="{ 'fixed-header': fixedHeader }">
        <navbar @setLayout="setLayout" @switchFactory="switchFactory" />
      ...
      <el-dialog v-model="openSwitchFactory" title="厂区切换" width="300">
        <SwitchFactory />
      </el-dialog>
    </el-container>
  </el-container>
...
import SwitchFactory from '@/components/SwitchFactory/index.vue'
...
const openSwitchFactory = ref(false)
...
function switchFactory() {
  console.log('switchFactory')
  openSwitchFactory.value = true
}
