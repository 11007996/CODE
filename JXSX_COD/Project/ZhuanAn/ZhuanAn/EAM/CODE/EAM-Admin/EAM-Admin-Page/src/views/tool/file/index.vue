<template>
  <div class="app-container">
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="fileName" label="文件名" align="left" min-width="200" :show-overflow-tooltip="true">
        <template #default="scope">
          <el-link type="primary" :href="scope.row.accessUrl" target="_blank">{{ scope.row.fileName }}</el-link>
        </template>
      </el-table-column>
      <el-table-column prop="realName" label="原文件名" align="left" min-width="200" :show-overflow-tooltip="true" />
      ...
      <el-table-column prop="fileSize" label="文件大小" align="center" :show-overflow-tooltip="true" min-width="120" />
      <el-table-column prop="fileExt" label="扩展名" align="center" :show-overflow-tooltip="true" width="80" />
      ...
      <el-table-column prop="storePath" label="存储目录" min-width="160" />
      <el-table-column prop="create_by" label="操作人" align="center" width="90" />
      ...
      <el-table-column label="操作" align="center" width="160">
        <template #default="scope">
          ...
          <el-button v-hasPermi="['tool:file:delete']" title="删除" text icon="delete" @click="handleDelete(scope.row)"> </el-button>
        </template>
      </el-table-column>
    </el-table>
