<template>
  <div class="navbar" :data-theme="sideTheme" :class="appStore.device + ' nav' + settingsStore.navType">
    ...
    <div class="right-menu">
      <LoginFactory class="right-menu-item" v-if="appStore.device == 'desktop'" />
      <header-search class="right-menu-item" />
      <Notice title="通知" class="right-menu-item" />
      <template v-if="appStore.device == 'desktop'">
        <screenfull title="全屏" class="right-menu-item" />
      </template>
      <router-link to="/qrcode/scan">
        <div title="扫描" class="right-menu-item">
          <svg-icon class-name="search-icon" name="scan" />
        </div>
      </router-link>
      ...
      <div class="right-menu-item">
        <el-dropdown @command="handleCommand" trigger="click" style="vertical-align: middle; white-space: nowrap">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              ...
              <router-link to="/system/info">
                <el-dropdown-item>{{ $t('layout.systemInfo') }}</el-dropdown-item>
              </router-link>
              ...
              <el-dropdown-item command="switchFactory">
                <span>切换厂区</span>
              </el-dropdown-item>
...
import LoginFactory from '@/components/LoginFactory/index'
...
const emits = defineEmits(['setLayout', 'switchFactory'])
function setLayout() {
  emits('setLayout')
}
