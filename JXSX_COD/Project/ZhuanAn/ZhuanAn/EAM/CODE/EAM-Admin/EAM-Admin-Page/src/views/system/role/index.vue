<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" highlight-current-row @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属工厂" prop="factoryId"></el-table-column>
...
import { treeDept as deptTreeselect, roleDeptTreeselect } from '@/api/system/dept'
...
function handleAuthUser(row) {
  ...
  var hasPermi = proxy.$auth.hasPermi('system:roleusers:list')
  if (hasPermi) {
