    ...
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      ...
      <el-form-item label="差异类型" prop="diffType">
        <el-select clearable v-model="queryParams.diffType" placeholder="请选择差异类型">
          <el-option v-for="item in options.diffType_options" :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue">
    ...
    <el-table
      ...
      <el-table-column prop="diffType" label="操作类型" align="center" v-if="columns.showColumn('diffType')">
        <template #default="scope">
          <dict-tag :options="options.diffType_options" :value="scope.row.diffType" />
        </template>
      </el-table-column>
      <el-table-column
        prop="businessData"
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="操作类型" prop="diffType">
              <dict-tag :options="options.diffType_options" :value="form.diffType"></dict-tag>
            </el-form-item>
          </el-col>
