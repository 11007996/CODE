...
const useSocketStore = defineStore('socket', {
  ...
  actions: {
    ...
    readPromptNotice(id) {
      console.log(id, this.promptNoticeList, this.promptNoticeReadList)
      this.promptNoticeReadList.push(id)
      let notread = this.promptNoticeList.filter((v) => !this.promptNoticeReadList.some((item) => item === v.noticeId))
      this.newNotice = notread.length
      console.log(id, this.promptNoticeList, this.promptNoticeReadList)
    },
    setGlobalError(data) {
