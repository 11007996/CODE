...
<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column prop="name" label="名称" min-width="160" align="center" :show-overflow-tooltip="true" />
      <el-table-column prop="content" label="模板内容" min-width="250" :show-overflow-tooltip="true" v-if="columns.showColumn('content')" />
      <el-table-column
        prop="createBy"
        label="创建人"
        width="90"
      ...
      <el-table-column label="操作" width="190">
        <template #default="scope">
          ...
          <el-button type="success" icon="edit" title="编辑" v-hasPermi="['tool:emailtpl:edit']" @click="handleUpdate(scope.row)"></el-button>
          <el-button type="danger" icon="delete" title="删除" v-hasPermi="['tool:emailtpl:delete']" @click="handleDelete(scope.row)"></el-button>
        </template>
      </el-table-column>
    </el-table>
