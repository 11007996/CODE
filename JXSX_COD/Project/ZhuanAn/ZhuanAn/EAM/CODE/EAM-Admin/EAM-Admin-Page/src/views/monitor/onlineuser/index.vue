    ...
    <el-row :gutter="20" v-if="viewSwitch == 2">
      <el-col v-for="item in onlineUsers" :lg="4" :span="24">
        <el-card :body-style="{ padding: '15px 15px 0' }">
          ...
          <div>
            <el-button text @click="onChat(item)" icon="ChatDotRound" title="私信" v-hasRole="['admin']">私信</el-button>
            <el-button text @click="onLock(item)" icon="lock" title="强退" v-hasPermi="['monitor:online:forceLogout']">强退</el-button>
          </div>
        </el-card>
      </el-col>
