    ...
    children: [
      {
        ...
        name: 'info',
        meta: { title: '系统信息', icon: 'international', titleKey: 'menu.systemInfo' }
      }
    ]
  },
  {
    ...
    component: () => import('@/views/workflow/template/layout/index.vue'),
    hidden: true
  },
  {
    //扫描
    path: '/qrcode/scan',
    component: () => import('@/components/QRCodeScan/Html5Qrcode.vue'),
    hidden: true
  }
]
