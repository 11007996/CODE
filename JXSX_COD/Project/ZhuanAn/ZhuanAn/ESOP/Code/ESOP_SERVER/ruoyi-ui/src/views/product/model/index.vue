...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="modelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="机种编号" align="center" prop="modelId" />
      <el-table-column label="机种名称" align="center" prop="modelName" />
      <el-table-column label="机种状态" align="center" prop="status" >
...
<script>
import { listModel, getModel, delModel, addModel, updateModel, changeModelStatus } from "@/api/product/model";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        modelName: [
          { required: true, message: "机种名称不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.modelName + '"机种吗？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('product/model/export', {
        ...this.queryParams
