    ...
    <div class="app-container">
        ...
        >
            <el-form-item label="区段名称" prop="stageId">
                <el-select v-model="queryParams.stageId" placeholder="请选择区段名称">
                    <el-option
            ...
            <!--      <el-form-item label="区段id" prop="stageId">-->
            <!--        <el-input-->
        ...
        <el-table v-loading="loading" :data="processList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="制程编号" align="center" prop="processId" />
            <el-table-column label="制程名称" align="center" prop="processName" />
            <el-table-column label="制程类型" align="center" prop="processType">
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="区段名称" prop="stageId">
                    <el-select v-model="form.stageId" placeholder="请选择区段名称">
                        <el-option
                            v-for="item in stageOptions"
                            :key="item.stageId"
                            :label="item.stageName"
                ...
                <el-form-item label="制程名称" prop="processName">
                    <el-input v-model="form.processName" placeholder="请输入制程名称" />
                </el-form-item>

                <el-form-item label="制程类型" prop="processType">
                    <el-select v-model="form.processType" placeholder="请选择制程类型">
                        <el-option
...
export default {
    ...
    methods: {
        ...
        handleDelete(row) {
            ...
            this.$modal
                .confirm('是否确认删除制程编号为"' + processIds + '"的数据项？')
                .then(function() {
