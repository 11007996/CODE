...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="siteList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="厂区编号" align="center" prop="siteId" />
      <el-table-column label="厂区名称" align="center" prop="siteName" />
...
<!--          >删除</el-button>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="厂区名称" prop="siteName">
          <el-input v-model="form.siteName" placeholder="请输入厂区名称" />
        </el-form-item>
...
<script>
import { listSite, getSite, delSite, addSite, updateSite,changeSiteStatus } from "@/api/product/site";
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.siteName + '"厂区吗？').then(function() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除厂区管理编号为"' + siteIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('product/site/export', {
        ...this.queryParams
