export default {
    bind(el, binding, vnode, oldVnode) {
        ...
        maxMin.innerHTML =
            ...
            " onMouseOver=\"this.style.color='#409EFF'\" onMouseOut=\"this.style.color='#909399'\"></i>";
        ...
        function setMaxMin() {
            if (el.fullscreen) {
                ...
                maxMin.title = "还原";
                bodyHeight =
                    dragDom.querySelector(".el-dialog__body").offsetHeight +
                    "px";
